export const programsTheme = {
  programsCurrent: {
    ...
    layoutGrid: 'grid items-stretch gap-10 sm:grid-cols-1 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,1fr)]',
    leftCol: 'space-y-5 text-slate-900',
    bodyParagraph: 'text-sm leading-7 text-slate-700 sm:text-base break-words',
    richText:
      '[&_p]:text-slate-700 [&_p]:leading-7 [&_p:not(:first-child)]:mt-4 [&_p]:break-words [&_strong]:font-semibold [&_.ql-align-justify]:text-justify [&_a]:text-[var(--brand-accent)] [&_a]:underline [&_a]:underline-offset-4 [&_img]:max-w-full [&_img]:h-auto',
    descriptionScrollable: 'max-h-[200px] overflow-y-auto pr-2',
    themeBlock: 'mt-4 space-y-3',
    themeHeading: 'text-sm font-semibold uppercase tracking-wide text-primary',
    themeTitle: 'mt-1 text-sm font-semibold text-slate-900 sm:text-base break-words',
    subthemesGrid:
    ...
    themeCard:
      'rounded-2xl bg-white px-4 py-3 text-sm font-medium text-slate-900 shadow-[0_10px_30px_rgba(15,23,42,0.08)] ring-1 ring-slate-200/80',
    rightCol: 'mx-auto w-full sm:w-fit',
    rightCard:
      'w-full rounded-3xl bg-white p-4 shadow-[0_18px_60px_rgba(15,23,42,0.18)] ring-1 ring-slate-200/80 sm:p-5 sm:w-[380px]',
    ...
    instagramCaption: 'mt-4 line-clamp-4 text-sm font-medium text-slate-800',
    instagramControls: 'mt-4 flex min-w-0 items-center gap-3 px-4',
    instagramDotsWrapper: 'flex items-center gap-2',
    instagramDot: 'h-2.5 rounded-full transition-all',
    instagramDotActive: 'w-7 bg-primary',
    instagramDotInactive: 'w-2.5 bg-slate-300 hover:bg-slate-400',
    instagramLink: 'ml-auto inline-flex min-w-0 items-center gap-1 text-sm font-semibold text-primary transition hover:text-primary/80',
    instagramLinkText: 'truncate',
    instagramLinkIcon: 'h-4 w-4',
  },
  programsPrevious: {
  ...
  programsActivities: {
    ...
    cardsGrid:
      'mt-8 flex snap-x snap-mandatory gap-3 overflow-x-auto pb-2 pt-1 pl-1 pr-4 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden sm:grid sm:grid-cols-3 sm:gap-4 sm:overflow-visible sm:pb-0 sm:pt-0 sm:pr-0',
    card: 'flex min-h-[180px] min-w-[85%] snap-start flex-col rounded-2xl bg-white px-4 py-4 ring-1 ring-slate-200 sm:min-w-0 sm:px-5 sm:py-5',
  ...
  programsSchedules: {
    ...
    listWrapper: 'mt-8 space-y-8',
    groupHeader: 'mb-4 flex items-center justify-between gap-3',
    groupTitle: 'text-lg font-bold text-slate-900 sm:text-xl',
    groupCount:
      'inline-flex items-center rounded-full bg-slate-100 px-2.5 py-1 text-xs font-semibold text-slate-600',
    timelineWrapper: 'space-y-5',
    timelineItem: 'flex items-stretch gap-4 sm:gap-5',
    timelineMarkerCol: 'flex w-3 flex-col items-center pt-1.5',
    timelineDot: 'h-3 w-3 shrink-0 rounded-full shadow-[0_0_0_3px_rgba(255,255,255,1)]',
    timelineDotActive: 'bg-emerald-500',
    timelineDotUpcoming: 'bg-amber-500',
    timelineDotClosed: 'bg-slate-400',
    timelineConnector: 'mt-1 w-px flex-1 bg-slate-200',
    card: 'min-w-0 flex-1 rounded-xl border border-slate-200 border-l-4 bg-white p-4 shadow-sm transition-opacity sm:p-5',
    cardAccentActive: 'border-l-emerald-500',
    cardAccentUpcoming: 'border-l-amber-500',
    cardAccentClosed: 'border-l-slate-300 opacity-80',
    cardHeader: 'flex flex-wrap items-center justify-between gap-2',
    cardDate: 'text-sm font-semibold text-slate-700',
    cardTitle: 'mt-2 break-words text-base font-bold text-slate-900 sm:text-lg',
    cardDescription: 'mt-1 break-words text-sm leading-relaxed text-slate-600',
    ...
    emptyState:
      'mx-auto mt-8 flex max-w-md flex-col items-center rounded-2xl bg-slate-50 px-6 py-10 text-center ring-1 ring-slate-200',
    emptyStateIconWrapper:
      'grid h-12 w-12 place-items-center rounded-full bg-primary/10 text-primary',
    emptyStateIcon: 'h-6 w-6',
    emptyStateTitle: 'mt-4 text-base font-bold text-slate-900',
  ...
  programRundowns: {
    sectionWrapper: 'px-6 py-12 sm:py-14 md:py-16 lg:px-8',
    container: 'mx-auto max-w-7xl',
    tabWrapper: 'mx-auto mt-2 w-full overflow-hidden rounded-2xl border border-blue-100 bg-white',
    tabGrid: 'grid grid-cols-4',
    tabButton:
    ...
    tabLabel: 'inline-flex items-center justify-center gap-2',
    ...
    listWrapper: 'mt-6 space-y-5',
    card: 'min-h-[170px] rounded-2xl bg-blue-50/70 p-5 ring-1 ring-blue-100 sm:min-h-[150px]',
    cardInner: 'flex h-full flex-col gap-4 sm:flex-row sm:items-start sm:justify-between',
    cardTitle: 'text-lg font-extrabold text-blue-900',
    cardDescription: 'mt-1 max-w-3xl text-sm leading-6 text-slate-700 line-clamp-3',
    metaRow: 'flex flex-col gap-2 sm:text-right',
    metaItem: 'inline-flex items-center gap-2',
    metaItemDate: 'text-sm font-semibold text-blue-900',
    metaItemTime: 'text-sm text-slate-700',
    metaItemDuration: 'text-xs text-slate-500',
    noteWrapper: 'mt-4 flex items-start gap-3 rounded-xl bg-blue-50 p-4 ring-1 ring-blue-200',
    noteText: 'text-sm leading-6 text-blue-900',
