export const programsTheme = {
  ...
  programsSchedules: {
    ...
    timelineWrapper: 'relative space-y-6 pl-6 before:absolute before:left-2 before:top-2 before:h-[calc(100%-8px)] before:w-0.5 before:bg-slate-200 sm:pl-8',
    timelineItem: 'relative',
    timelineDot: 'absolute left-[-1.375rem] top-1.5 h-3 w-3 rounded-full border-2 border-white bg-slate-300 sm:left-[-1.875rem]',
    timelineDotActive: 'bg-emerald-500',
    timelineDotUpcoming: 'bg-amber-500',
    timelineDotClosed: 'bg-slate-400',
    card: 'rounded-xl border border-slate-200 bg-white p-4 shadow-sm sm:p-5',
    cardHeader: 'flex flex-wrap items-center justify-between gap-2',
    cardDate: 'text-sm font-semibold text-slate-700',
    cardTitle: 'mt-2 text-base font-bold text-slate-900 sm:text-lg',
