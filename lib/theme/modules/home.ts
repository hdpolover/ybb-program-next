export const homeTheme = {
  ...
  testimonialsHome: {
    ...
    marqueeRowBase: 'flex gap-4 whitespace-nowrap sm:gap-6',
    card: 'my-2 inline-flex w-[280px] shrink-0 cursor-pointer flex-col overflow-hidden rounded-2xl bg-white p-4 text-left shadow-[0_10px_32px_rgba(2,6,23,0.07)] ring-1 ring-slate-200/70 transition hover:-translate-y-0.5 hover:shadow-[0_14px_44px_rgba(2,6,23,0.11)] sm:w-[320px] sm:p-5 md:w-[350px] lg:w-[380px]',
    cardHeaderRow: 'flex items-start justify-between gap-3',
    profileRow: 'flex min-w-0 items-center gap-3',
    avatarWrapper: 'relative h-11 w-11 flex-shrink-0 overflow-hidden rounded-full bg-slate-100 ring-1 ring-slate-200',
    avatarImg: 'object-cover',
    profileMetaCol: 'min-w-0',
    quote: 'mt-4 whitespace-normal break-words text-sm italic leading-6 text-slate-700',
    metaRow: 'mt-4 flex items-center justify-between border-t border-slate-100 pt-3',
    nameRow: 'truncate text-sm font-semibold text-slate-900',
    nameFlag: 'text-base',
    roleText: 'line-clamp-1 text-xs text-slate-500',
    yearPill:
