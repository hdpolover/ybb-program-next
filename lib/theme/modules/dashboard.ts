export const dashboardTheme = {
  ...
  dashboardPayments: {
    ...
    summaryGrid: 'grid grid-cols-2 gap-3 sm:grid-cols-2 sm:gap-4 lg:grid-cols-4',
    summaryCardBase: 'flex flex-col justify-between rounded-2xl p-3 text-sm shadow-sm sm:p-4',
    ...
    summaryCardInner: 'flex items-center justify-between gap-2 sm:gap-3',
    summaryEyebrow: 'text-[10px] font-semibold uppercase tracking-wide leading-tight sm:text-xs',
    ...
    summaryValue: 'mt-0.5 text-[1.7rem] font-extrabold leading-none sm:mt-1 sm:text-2xl',
    ...
    categoryTitle: 'text-xs font-extrabold uppercase tracking-wide text-slate-700 sm:text-sm',
    ...
    tableSearchWrapper:
      'flex w-full items-center gap-2 rounded-full border border-slate-200 bg-slate-50 px-3 py-1.5 text-xs text-slate-600 sm:w-auto',
    tableSearchInput:
