export const authTheme = {
  ...
  onboarding: {
    layoutGrid: 'grid h-screen w-full grid-cols-1 overflow-hidden lg:grid-cols-[minmax(0,1fr)_auto]',
    leftCol: 'relative bg-white flex flex-col h-screen lg:rounded-r-3xl',
    leftCenter: 'flex-1 overflow-y-auto flex flex-col items-center justify-start px-4 py-8 lg:px-16 lg:pt-16 lg:pb-8 w-full',
    logoWrapper: 'mb-8',
    logoImage: 'h-20 w-auto sm:h-24',
    ...
    questionTitle: 'mt-6 text-xl font-bold tracking-tight text-slate-900',
    ...
    buttonGroup: 'pt-2 flex gap-3 w-full',
