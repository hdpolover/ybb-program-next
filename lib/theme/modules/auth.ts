export const authTheme = {
  login: {
    ...
    formPanelOuter: 'w-full h-full min-h-0 overflow-y-auto px-4 py-6 sm:px-6 sm:py-8 lg:px-16 lg:py-10',
    formPanelInner: 'flex min-h-full w-full items-center justify-center',
    formPanelCard: 'w-full max-w-[100%] sm:max-w-[480px]',
  ...
  onboarding: {
    ...
    stepLine: 'mt-4 text-sm leading-relaxed text-slate-500 sm:mt-6',
    ...
    buttonGroup: 'pt-3 flex gap-3 w-full sm:pt-4',
