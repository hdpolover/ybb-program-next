export const authTheme = {
  login: {
    ...
    googleButton:
      'inline-flex w-full cursor-pointer items-center justify-center gap-3 rounded-xl border border-slate-200 bg-white px-5 py-3 hover:shadow-sm active:scale-[0.98] text-sm font-medium text-slate-600 transition-all hover:bg-slate-50',
  ...
  onboarding: {
    ...
    leftCenter: 'flex-1 overflow-y-auto flex flex-col items-center justify-center px-3 py-1 sm:px-4 lg:px-4 lg:py-2 w-full',
    logoWrapper: 'mb-8',
    ...
    stepLine: 'mt-6 text-sm text-slate-500',
    stepLineEmphasis: 'font-semibold text-primary',
    questionTitle: 'mt-4 text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl',
