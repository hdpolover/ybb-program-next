...
describe('RegistrationTypePrograms (programs page)', () => {
  ...
  it('two editions: renders a tab bar and switches content on click', () => {
    render(
      <RegistrationTypePrograms
        programs={
          [
    ...
    // Defaults to the soonest-closing OPEN edition (6th), matching the
    // sticky countdown banner (home.strategy.ts orders `programs` the same
    // way).
