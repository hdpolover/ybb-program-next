              ...
              <span className="inline-flex items-center gap-2">
                ...
                {accountId !== "-" && (
                  <button
                    ...
                    className="inline-flex h-7 w-7 items-center justify-center rounded-full text-slate-500 ring-1 ring-slate-200 transition hover:bg-slate-50 hover:text-slate-700 focus:outline-none focus:ring-2 focus:ring-pink-400"
