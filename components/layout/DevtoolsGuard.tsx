      ...
      <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl ring-1 ring-slate-200">
        ...
        <form onSubmit={onSubmit} className="mt-5 space-y-4">
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <button
              type="submit"
              className="inline-flex items-center justify-center rounded-lg bg-primary px-4 py-2 text-xs font-semibold uppercase tracking-wide text-white shadow-sm hover:bg-primary"
            >
              Unlock
            </button>
          </div>
